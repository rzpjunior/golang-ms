...
// PurchaseOrderSignature: struct to hold signature data for purchase_order
...
func (m *PurchaseOrderSignature) MarshalJSON() ([]byte, error) {
	type Alias PurchaseOrderSignature
...
func (m *PurchaseOrderSignature) Save(fields ...string) (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
...
func (m *PurchaseOrderSignature) Read(fields ...string) error {
	o := orm.NewOrm()
	o.Using("read_only")
