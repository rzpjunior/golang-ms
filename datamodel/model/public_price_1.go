...
func init() {
	orm.RegisterModel(new(PublicPrice1))
}

type PublicPrice1 struct {
	...
	Area               *PublicArea1    `orm:"column(area_id);null;rel(fk)" json:"area"`
	Product            *PublicProduct1 `orm:"column(product_id);null;rel(fk)" json:"product"`
...
func (PublicPrice1) TableName() string {
	return "public_price_1"
}

// MarshalJSON : function to customize data struct into json. encrypt all key ids
func (m *PublicPrice1) MarshalJSON() ([]byte, error) {
	type Alias PublicPrice1
...
func (m *PublicPrice1) Save(fields ...string) (err error) {
	o := orm.NewOrm()
	o.Using("scrape")
...
func (m *PublicPrice1) Read(fields ...string) error {
	o := orm.NewOrm()
	o.Using("scrape")
