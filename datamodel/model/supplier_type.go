...
func init() {
	orm.RegisterModel(new(SupplierType))
}

// SupplierType : struct to hold supplier type model data for database
...
func (m *SupplierType) MarshalJSON() ([]byte, error) {
	type Alias SupplierType
...
func (m *SupplierType) Save(fields ...string) (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
...
func (m *SupplierType) Read(fields ...string) error {
	o := orm.NewOrm()
	o.Using("read_only")
