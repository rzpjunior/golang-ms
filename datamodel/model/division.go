...
func (m *Division) MarshalJSON() ([]byte, error) {
	type Alias Division
...
func (m *Division) Save(fields ...string) (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
...
func (m *Division) Delete() (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
		var i int64
...
// assigned.
func (m *Division) Read(fields ...string) error {
	o := orm.NewOrm()
	o.Using("read_only")
