...
type Koli struct {
	...
	Quantity float64 `orm:"-" json:"quantity"`
}

// MarshalJSON customized data struct when marshaling data
// into JSON format, all Primary key & Foreign key will be encrypted.
func (m *Koli) MarshalJSON() ([]byte, error) {
	type Alias Koli
...
// Save inserting or updating Koli struct into koli table.
// It will updating if this struct has valid Id
// if not, will inserting a new row to koli.
// The field parameter is an field that will be saved, it is
// usefull for partial updating data.
func (m *Koli) Save(fields ...string) (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
...
// Delete permanently deleting koli data
// this also will truncated all data from all table
// that have relation with this koli.
func (m *Koli) Delete() (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
		var i int64
...
// assigned.
func (m *Koli) Read(fields ...string) error {
	o := orm.NewOrm()
	o.Using("read_only")
