...
// UserPermission model for UserPermission table.
type UserPermission struct {
	...
	PermissionValue string      `orm:"column(permission_value);size(50);null" json:"permission_value"`
}

// MarshalJSON customized data struct when marshaling data
// into JSON format, all Primary key & Foreign key will be encrypted.
func (m *UserPermission) MarshalJSON() ([]byte, error) {
...
func (m *UserPermission) Save(fields ...string) (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
...
func (m *UserPermission) Delete() (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
		var i int64
