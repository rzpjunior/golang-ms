...
// Province model for province table.
type Province struct {
	ID            int64    `orm:"column(id);auto" json:"-"`
	Country       *Country `orm:"column(country_id);null;rel(fk)" json:"country,omitempty"`
...
func (m *Province) MarshalJSON() ([]byte, error) {
	type Alias Province
...
func (m *Province) Save(fields ...string) (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
...
func (m *Province) Delete() (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
		var i int64
...
// assigned.
func (m *Province) Read(fields ...string) error {
	o := orm.NewOrm()
	o.Using("read_only")
