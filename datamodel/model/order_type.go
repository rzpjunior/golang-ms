...
// OrderType model for district table.
type OrderType struct {
	...
	MinOrderQty   float64 `orm:"column(min_order_qty)" json:"min_order_qty"`
	MinUnitPrice  float64 `orm:"column(min_unit_price)" json:"min_unit_price"`
...
func (OrderType) TableName() string {
	return "order_type_sls"
}

// MarshalJSON customized data struct when marshaling data
// into JSON format, all Primary key & Foreign key will be encrypted.
func (m *OrderType) MarshalJSON() ([]byte, error) {
...
func (m *OrderType) Save(fields ...string) (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
...
func (m *OrderType) Delete() (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
		var i int64
...
// assigned.
func (m *OrderType) Read(fields ...string) error {
	o := orm.NewOrm()
	o.Using("read_only")
