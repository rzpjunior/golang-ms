...
// City model for city table.
type City struct {
	ID            int64     `orm:"column(id);auto" json:"-"`
	Province      *Province `orm:"column(province_id);null;rel(fk)" json:"province,omitempty"`
...
func (m *City) Save(fields ...string) (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
...
// assigned.
func (m *City) Read(fields ...string) error {
	o := orm.NewOrm()
	o.Using("read_only")
