module git.edenfarm.id/project-version3/erp-services/erp-boilerplate-service

go 1.18

require (
	git.edenfarm.id/edenlabs/edenlabs v0.0.7
	git.edenfarm.id/project-version3/erp-pkg/erp-client-grpc v0.0.1
	git.edenfarm.id/project-version3/erp-services/erp-protobuf v0.0.7
