...
import (
	...
	"git.edenfarm.id/project-version3/erp-services/erp-storage-service/internal/app/handler"
...
func StartGrpcServer() (err error) {
	...
	// setup handler
	storageGrpcHandler := &handler.StorageGrpcHandler{
		Option:         global.Setup,
		ServicesUpload: service.NewUploadService(),
	}
	pb.RegisterStorageServiceServer(srv, storageGrpcHandler)
