...
func StartGrpcServer() (err error) {
	...
	// setup handler
	customerMobileGrpcHandler := &handler.CustomerMobileGrpcHandler{
		Option:              global.Setup,
		ServiceUserCustomer: service.NewUserCustomerService(),
	}
	pb.RegisterCustomerMobileServiceServer(srv, customerMobileGrpcHandler)
