...
import (
	...
	"git.edenfarm.id/project-version3/erp-services/erp-notification-service/internal/app/handler"
...
func StartGrpcServer() (err error) {
	...
	// setup handler
	notificationGrpcHandler := &handler.NotificationGrpcHandler{
		Option:                               global.Setup,
		ServicesNotificationTransaction:      service.NewNotificationTransactionService(),
		ServicesNotificationCampaign:         service.NewNotificationCampaignService(),
		ServicesNotificationSite:             service.NewNotificationSiteService(),
		ServicesNotificationPurchaser:        service.NewNotificationPurchaserService(),
		ServicesNotificationCancelSalesOrder: service.NewNotificationCancelSalesOrderService(),
		ServicesNotificationPaymentReminder:  service.NewNotificationPaymentReminderService(),
	}
	pb.RegisterNotificationServiceServer(srv, notificationGrpcHandler)
