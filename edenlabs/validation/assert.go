...
func IsEmail(value interface{}) bool {
	...
	return EmailPattern.MatchString(utils.ToString(value))
}
...
func IsJSON(value interface{}) bool {
	...
	return json.Unmarshal([]byte(utils.ToString(value)), &js) == nil
}
...
func ChangeType(val interface{}) (x float64) {
	...
	case reflect.String:
		...
		str := utf8.RuneCountInString(utils.ToString(v))
		x = float64(str)
		break
	case reflect.Slice:
...
func IsContains(value interface{}, substring string) bool {
	...
	return strings.Contains(utils.ToString(value), substring)
}
...
func IsMatches(value interface{}, pattern string) bool {
	...
	match, _ := regexp.MatchString(pattern, utils.ToString(value))
	return match
}
...
func IsSame(value interface{}, param interface{}) bool {
	...
	return value == utils.ToString(param)
}
