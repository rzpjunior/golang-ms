...
func Test_IsAlphanumericSpace(t *testing.T) {
	t.Parallel()
...
func Test_IsLowerThenEqual(t *testing.T) {
	t.Parallel()
	x := int(7)
...
func Test_IsGreaterThanEqual(t *testing.T) {
	t.Parallel()
	x := int(7)
...
func Test_IsLowerThan(t *testing.T) {
	t.Parallel()
	x := int(7)
	var tests = []struct {
		value    interface{}
...
func Test_IsOnRange(t *testing.T) {
	t.Parallel()
...
func Test_IsMatches(t *testing.T) {
	t.Parallel()
...
func Test_IsValidEan(t *testing.T) {
	tests := []struct {
		ean      string
		expected bool
	}{
