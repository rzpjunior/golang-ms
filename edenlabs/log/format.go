...
func (f *LogFormatter) textFormater(entry *logrus.Entry) ([]byte, error) {
	...
	// }
	fmt.Fprintf(b, format, ansi.LightMagenta, entry.Time.Format(timestampFormat), ansi.Reset, levelColor, levelText, ansi.Reset, prefix, message)
