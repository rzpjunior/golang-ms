...
type Customer struct {
	...
	SalesPaymentTermID         int64     `orm:"column(payment_term_sls_id)" json:"payment_term_sls_id"`
	CustomerTypeID             string    `orm:"column(customer_type_id)" json:"customer_type_id"`
}
