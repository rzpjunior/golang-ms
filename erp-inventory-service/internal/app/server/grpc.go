...
import (
	...
	"git.edenfarm.id/project-version3/erp-services/erp-inventory-service/internal/app/handler"
...
func StartGrpcServer() (err error) {
	...
	// setup handler
	catalogGrpcHandler := &handler.CatalogGrpcHandler{
		Option:               global.Setup,
		ServicesItemImage:    service.NewItemImageService(),
		ServicesItemCategory: service.NewItemCategoryService(),
		ServicesItem:         service.NewItemService(),
	}
	pb.RegisterCatalogServiceServer(srv, catalogGrpcHandler)
