...
import (
	...
	"git.edenfarm.id/project-version3/erp-services/erp-campaign-service/internal/app/server"
...
func start() {
	...
	global.Setup.Common.Client.CustomerMobileServiceGrpc, err = grpcProvider.ConnectCustomerMobileServiceGrpc(grpcProvider.ProviderOptions{
		Common: global.Setup.Common,
	})
	if err != nil {
		logrus.Error(err.Error())
