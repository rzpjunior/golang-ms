...
func (c *createRequest) Validate() *validation.Output {
	...
	if c.Code, err = util.CheckTable("term_payment_sls"); err != nil {
	...
	if _, countName, err := repository.CheckSalesTermData(filter, exclude); err != nil {
...
func (c *createRequest) Messages() map[string]string {
	return map[string]string{
		...
		"days_value.required": util.ErrorInputRequired("days value"),
	}
}
