...
func (h *Handler) read(c echo.Context) (e error) {
	...
	var data []*model.PaymentGroup
	var total int64

	if data, total, e = repository.GetPaymentGroups(rq); e == nil {
		ctx.Data(data, total)
	}
...
func (h *Handler) readFilter(c echo.Context) (e error) {
	...
	if data, total, e = repository.GetFilterPaymentGroups(rq); e == nil {
		ctx.Data(data, total)
	}
...
func (h *Handler) detail(c echo.Context) (e error) {
	...
	if id, e = ctx.Decrypt("id"); e == nil {
		if ctx.ResponseData, e = repository.GetPaymentGroup("id", id); e != nil {
			e = echo.ErrNotFound
		}
	}
