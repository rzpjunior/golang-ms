...
func (h *Handler) read(c echo.Context) (e error) {
	...
	if data, total, e = repository.GetDistricts(rq); e == nil {
		ctx.Data(data, total)
	}
...
func (h *Handler) readFilter(c echo.Context) (e error) {
	...
	if data, total, e = repository.GetFilterDistricts(rq); e == nil {
		ctx.Data(data, total)
	}
...
func (h *Handler) detail(c echo.Context) (e error) {
	...
	if id, e = ctx.Decrypt("id"); e == nil {
		if ctx.ResponseData, e = repository.GetDistrict("id", id); e != nil {
			e = echo.ErrNotFound
		}
	}
