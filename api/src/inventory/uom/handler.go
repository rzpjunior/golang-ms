...
func (h *Handler) URLMapping(r *echo.Group) {
	r.GET("", h.read, auth.Authorized("uom_rdl"))
	r.GET("/:id", h.detail, auth.Authorized("uom_rdd"))
	r.GET("/filter", h.readFilter, auth.Authorized("filter_rdl"))
	r.POST("", h.create, auth.Authorized("uom_crt"))
}
...
func (h *Handler) read(c echo.Context) (e error) {
	...
	if data, total, e = repository.GetUoms(rq); e == nil {
		ctx.Data(data, total)
	}
...
func (h *Handler) readFilter(c echo.Context) (e error) {
	...
	if data, total, e = repository.GetFilterUoms(rq); e == nil {
		ctx.Data(data, total)
	}
...
func (h *Handler) detail(c echo.Context) (e error) {
	...
	if id, e = ctx.Decrypt("id"); e == nil {
		if ctx.ResponseData, e = repository.GetUom("id", id); e != nil {
			e = echo.ErrNotFound
		}
	}
