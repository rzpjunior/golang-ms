...
func (h *Handler) read(c echo.Context) (e error) {
	...
	if data, total, e = repository.GetProvincies(rq); e == nil {
		ctx.Data(data, total)
	}
...
func (h *Handler) readFilter(c echo.Context) (e error) {
	...
	if data, total, e = repository.GetFilterProvincies(rq); e == nil {
		ctx.Data(data, total)
	}
...
func (h *Handler) detail(c echo.Context) (e error) {
	...
	if id, e = ctx.Decrypt("id"); e == nil {
		if ctx.ResponseData, e = repository.GetProvince("id", id); e != nil {
			e = echo.ErrNotFound
		}
	}
