...
// createRequest : struct to hold customer tag request data
...
func (c *createRequest) Validate() *validation.Output {
	...
	if c.Code, err = util.CheckTable("tag_customer"); err != nil {
	...
	if _, countName, err := repository.CheckCustomerTagData(filter, exclude); err != nil {
