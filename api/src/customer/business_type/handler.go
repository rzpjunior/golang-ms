...
func (h *Handler) read(c echo.Context) (e error) {
	...
	var data []*model.BusinessType
	var total int64

	if data, total, e = repository.GetBusinessTypes(rq); e == nil {
		ctx.Data(data, total)
	}
...
func (h *Handler) readFilter(c echo.Context) (e error) {
	...
	if data, total, e = repository.GetFilterBusinessTypes(rq); e == nil {
		ctx.Data(data, total)
	}
...
func (h *Handler) detail(c echo.Context) (e error) {
	...
	if id, e = ctx.Decrypt("id"); e == nil {
		if ctx.ResponseData, e = repository.GetBusinessType("id", id); e != nil {
			e = echo.ErrNotFound
		}
	}
