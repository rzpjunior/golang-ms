...
class goodsReceiptController extends Controller
{
    public function getPrint(Request $request)
    {
        ...
        $qrCode = QrCode::generate( $request['gr']['code']);
        $pdf = new Dompdf();
        ...
        $data = array(
            ...
            'createdAtGR' => date_create($request['gr']['created_at']),
            'ataGR' => date_create($request['gr']['ata_date']),
            'etaPO' => date_create($request['gr']['purchase_order']['eta_date']),
            'recognition_datePO' => date_create($request['gr']['purchase_order']['recognition_date']),
            'session' => $request['session']
        );

        $html = view('gr',$data)->render();
