...
class supplierReturnController extends Controller
{
    public function getPrint(Request $request)
    {
        ...
        $qrCode = QrCode::generate( $request['sr']['code']);
        $pdf = new Dompdf();
        ...
        $data = array(
            ...
            'recognitionDate' => date_create($request['sr']['recognition_date']),
            'createdAtGR' => date_create($request['sr']['good_receipt']['created_at']),
            'ataGR' => date_create($request['sr']['good_receipt']['ata_date']),
            'session' => $request['session']
        );

        $html = view('sr',$data)->render();
