...
class wasteDisposalController extends Controller
{
    ...
    public function getPrint(Request $request)
    {
        ...
        $qrCode = QrCode::generate($request['wd']['code']);
        ...
        $data = array(
            ...
            'recognitionDate' => date_create($request['wd']['recognition_date']),
//            'deliveryDate' => date_create($request['wd']['delivery_date'])
        );

        $html = view('wd',$data)->render();
...
//       $pdf->setOptions(['defaultFont' => 'Open Sans', 'isRemoteEnabled'=> true, 'isPhpEnabled'=>true]);
        ...
        $chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz";
            ...
            $t=time();
        $filename= $data['waste']['code'].'_'.$t.$str.'.pdf';
