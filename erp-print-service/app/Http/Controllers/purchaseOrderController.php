...
class purchaseOrderController extends Controller
{
    public function getPrint(Request $request)
    {
        ...
        $qrCode = QrCode::generate( $request['po']['code']);
        $pdf = new Dompdf();
        ...
        $data = array(
            ...
            'orderDate' => date_create($request['po']['recognition_date']),
            'etaDate' => date_create($request['po']['eta_date']),
            'session' => $request['session']
        );

        $html = view('po',$data)->render();
