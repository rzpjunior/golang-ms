    ...
    <section class="sheet" style="padding: 10px;">
        ...
        <div style="float:right; margin-top:-120px;">
            ...
            <table style="font-size: 12px; margin-top: 15px" cellspacing="0" border="0" width="100%">
                <tr>
                    <td style="text-align: right"><strong>Purchase Order# :</strong></td>
                ...
                <tr>
                    ...
                    <td style="text-align: right" width=30%>{{ date_format($etaDate,"d/m/Y") }}</td>
                </tr>
            </table>
        </div>
        <table border="1" style="border-collapse: collapse; font-size: 12px; margin-top:20px;" width="100%">
            <tr>
                ...
                <td style="padding:5px;">
                    Payment Term : {{ $order['term_payment_pur']['name'] }}
                </td>
            </tr>
            <tr>
                <td style="padding:5px;">
                    PIC Supplier : {{ $order['supplier']['pic_name'] }}
                </td>
                <td style="padding:5px;">
                    Estimated Arrival Time : {{ $order['eta_time'] }}
                </td>
            </tr>
            <tr>
        ...
        <table border="1" style="border-collapse: collapse; font-size:12px;" width="100%">
            <thead>
                <tr>
                    ...
                    <th style="padding:5px;" width="13%">Tax (%)</th>
                    <th style="padding:5px;" width="13%">Include Tax</th>
                    <th style="padding:5px;" width="13%">Unit Price Tax</th>
                    <th style="padding:5px;" width="13%">Tax Amount</th>
                    <th style="padding:5px;" width="20%">Subtotal</th>
                </tr>
            </thead>
            <tbody>
                @foreach($order['purchase_order_items'] as $index => $items)
                <tr>
                    ...
                    <td style="padding:5px; text-align:right;">{{ number_format($items['tax_percentage'], 2,",",".") }}</td>
                    <td style="padding:5px; text-align:right;">{{ $items['include_tax_convert'] }}</td>
                    <td style="padding:5px; text-align:right;">{{ number_format($items['unit_price_tax'], 2,",",".") }}</td>
                    <td style="padding:5px; text-align:right;">{{ number_format($items['tax_amount'], 2,",",".") }}</td>
