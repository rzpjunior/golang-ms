    ...
    <table style="height:30px;" border="2" width="100%">
        <tr>
            <td style="text-align:center;" colspan="2">
                <h1>
                    {{ $items['picking']['sales_order']['code']}}-{{ $items['picking']['increment'] }}
                </h1> 
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="text-align:center; font-size:16px;">
                {{ $items['picking']['helper_code'] }} <br>
                {{ $items['picking']['sales_order']['wrt']['name'] }}
            </td>
        </tr>
        <tr>
            <td style="text-align:center; font-size:16px;">
               {{ $items['picking']['increment'] }} / {{ $items['picking']['total_koli'] }} Koli <br>
               @if ($items['picking']['print_label'] == 1)
                <i><span style="color: red">*</span> <span style="color: rgb(109, 109, 109);">Reprint</span> </i>  
               @endif
            </td>
        </tr>
    </table>
