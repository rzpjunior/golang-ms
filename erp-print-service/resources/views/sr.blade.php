...
<section class="sheet" style="padding: 10px;">
    ...
    <div style="float:right; margin-top:-120px;">
       <span style="float: right; margin-top:-40px; margin-right:-10px; font-size:21px;">
        ...
        <table style="font-size: 12px; margin-top: 15px" cellspacing="0" border="0" width="100%">
            ...
            <tr>
                <td style="text-align: right">Supplier Return Date :</td>
             ...
             <tr>
                ...
                <td style="text-align: right" width=30%><strong>{{ $order['good_receipt']['code'] }}</strong></td>
            </tr>
            <tr>
    ...
    <table border="1" style="border-collapse: collapse; font-size: 12px; margin-top:20px;" width="100%">
        <tr>
            <td width="50%" style="padding:8px;">Supplier : {{ $order['supplier']['name'] }}</td>
            <td width="50%" style="padding:8px;">Warehouse : {{ $order['site']['name'] }}</td>
        </tr>
        <tr>
            <td width="50%" style="padding:8px;">PIC Supplier : {{ $order['supplier']['pic_name'] }}</td>
            <td width="50%" style="padding:8px;">WH Address : {{ $order['site']['street_address'] }}</td>
        </tr>
        <tr>
    ...
    <table border="1" style="border-collapse: collapse; font-size:12px;" width="100%">
        ...
        <tbody>
        @foreach($order['supplier_return_items'] as $index => $items)
            <tr>
