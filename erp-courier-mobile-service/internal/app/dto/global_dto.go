...
type GlobalSalesOrder struct {
	...
	OrderDate     string     `json:"delivery_date,omitempty"`
...
type GlobalAdmDivsion struct {
	...
	City          string          `json:"city,omitempty"`
	District      *GlobalDistrict `json:"district,omitempty"`
...
type GlobalCustomer struct {
	...
	SalesPaymentTermID         int64      `json:"term_payment_sls_id,omitempty"`

	SalesPaymentTerm *GlobalSalesPaymentTerm `json:"term_payment_sls,omitempty"`
}
...
type GlobalSalesPaymentTerm struct {
	Id          int64      `json:"id,omitempty"`
	Code        string     `json:"code,omitempty"`
	Description string     `json:"description,omitempty"`
	Status      int32      `json:"status,omitempty"`
...
type GlobalDeliveryRunSheetItem struct {
	...
	GlobalDeliveryRunSheet *GlobalDeliveryRunSheet `json:"delivery_run_sheet,omitempty"`
	SalesOrder             *GlobalSalesOrder       `json:"sales_order,omitempty"`
	Courier                *GlobalCourier          `json:"courier,omitempty"`
}
