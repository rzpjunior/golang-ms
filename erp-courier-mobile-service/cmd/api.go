...
import (
	...
	"git.edenfarm.id/project-version3/erp-services/erp-courier-mobile-service/internal/app/server"
...
func start() {
	...
	global.Setup.Common.Client.LogisticServiceGrpc, err = grpcProvider.ConnectLogisticServiceGrpc(grpcProvider.ProviderOptions{
		Common: global.Setup.Common,
	})
	if err != nil {
		logrus.Error(err.Error())
	...
	global.Setup.Common.Client.SiteServiceGrpc, err = grpcProvider.ConnectSiteServiceGrpc(grpcProvider.ProviderOptions{
		Common: global.Setup.Common,
	})
	if err != nil {
		logrus.Error(err.Error())
